        ...
        <div className="lg:col-span-7 space-y-8 pr-0 lg:pr-12">
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="flex gap-4 mt-4 text-xs text-muted font-mono">
              ...
              <span className="hover:text-foreground cursor-pointer underline decoration-border underline-offset-4">
                Auth
              </span>
              <span className="hover:text-foreground cursor-pointer underline decoration-border underline-offset-4">
                RateLimit
